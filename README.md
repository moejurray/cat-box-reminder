...
- Pressing **Cat Box Cleaned Now** sends each active opted-in household member a confirmation text showing the next 36-hour check-in time in Pacific time.
...
- Production timing has been restored to a 36-hour timer with a 15-minute scheduler.
